...
import { e as useAuth, s as supabase, B as Button, T as TriangleAlert, R as RefreshCw } from "./AppContent-Bbhy20ck.js";
...
function CircularScore({ score, size = 112 }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", style: { width: size, height: size }, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-0 flex flex-col items-center justify-center", children: [
      ...
      ) : /* @__PURE__ */ jsxRuntimeExports.jsx(React.Fragment, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        motion.span,
        {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-12 gap-6", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          animate: "show",
          children: [
            data ? /* @__PURE__ */ jsxRuntimeExports.jsxs(React.Fragment, { children: [
            ...
            ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx(React.Fragment, { children: analysisFailed && imagePreview ? /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { variants: childVariants, className: "text-center py-12", children: [
