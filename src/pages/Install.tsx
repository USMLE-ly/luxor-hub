      ...
      >
        <div>
          ...
          <p className="text-muted-foreground font-sans text-sm">
            Add LEXOR® to your home screen for the best experience — instant access, offline support, and push notifications.
          </p>
        </div>
        ...
        {isInstalled ? (
          ...
          <div className="glass rounded-2xl p-8 space-y-4">
            ...
            <p className="text-muted-foreground font-sans text-xs">One tap to add LEXOR® to your home screen</p>
          </div>
        ) : isIOS ? (
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="font-sans text-xs text-muted-foreground">LEXOR® will appear on your home screen</p>
                </div>
              </div>
            </div>
          </div>
