...
const cardVariants = cva("absolute will-change-transform", {
  variants: {
    variant: {
      dark: "flex size-full flex-col items-center justify-center gap-6 rounded-2xl border border-border/50 bg-accent-foreground/80 p-6 backdrop-blur-md",
      light:
...
export const CardStackScroll: React.FC<
...
CardStackScroll.displayName = "CardStackScroll"
