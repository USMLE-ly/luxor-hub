...
const videoTestimonials = [
  {
    ...
    quote: "AURELIA's AI understood my aesthetic instantly. My followers noticed the upgrade before I even told them.",
    rating: 5,
  },
  {
    name: "James Chen",
  ...
  },
  {
    ...
    videoUrl: "https://www.youtube.com/embed/dQw4w9WgXcQ",
    quote: "My boutique revenue jumped 340% after integrating AURELIA's recommendations into our styling service.",
    rating: 5,
  },
];
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4">
        ...
        >
          ...
          <p className="mt-4 max-w-lg mx-auto font-sans text-sm text-muted-foreground">
            Real people, real transformations. Watch how AURELIA changed their style and their business.
          </p>
        </motion.div>
