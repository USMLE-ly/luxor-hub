...
function buildSystemPrompt(styleProfile: any, closetSummary: string, memoryContext: string, mood: string | null) {
  ...
  return `You are AURELIA, an elite AI personal stylist. You speak with warmth, confidence, and deep fashion knowledge.
    ...
    const stream = new ReadableStream({
      async start(controller) {
        ...
        try {
          ...
          const synthesisPrompt = `You are AURELIA's Chairman Synthesizer. Multiple AI stylists have answered the user's question and been ranked by quality. Synthesize the BEST final answer using the top-ranked insights.
...
- Maintain AURELIA's warm, confident voice
