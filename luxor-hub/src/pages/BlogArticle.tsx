...
const articles: Record<string, {
  ...
  "ai-outfit-recommendation-how-it-works": {
    ...
    sections: [
      ...
      { heading: "How the Neural Network Works", body: "At the core sits a neural network trained on millions of fashion images. But image recognition is only the start. LUXOR® layers contextual signals on top: calendar events, local forecast, dress codes, and mood." },
  ...
  "capsule-wardrobe-guide-minimalist-fashion": {
    ...
    sections: [
      ...
      { heading: "Auditing Your Closet", body: "Start with an honest audit. Photograph every item — LUXOR® does this automatically, categorizing by type, color, season, and versatility. Patterns emerge fast: duplicate black tees, unworn blazers, zero transitional layers." },
      ...
      { heading: "Color Cohesion Over Trends", body: "Color cohesion beats trend-chasing. Pick a neutral base (navy, charcoal, ivory), add two accent colors that match your skin tone. LUXOR®'s color analysis maps your complexion to a personalized palette." },
  ...
  "what-to-wear-to-work-office-outfit-ideas": {
    ...
    sections: [
      ...
      { heading: "Color Psychology at Work", body: "Navy and charcoal project authority. Pastels read approachable. Jewel tones signal confidence. LUXOR® factors in your industry and meeting schedule to pick the right register each day." },
  ...
  "color-analysis-for-fashion-find-your-season": {
    ...
    sections: [
      ...
      { heading: "AI-Powered Color Matching", body: "The traditional method uses fabric drapes under neutral light. AI has made it instant. LUXOR® uses your selfie to map skin undertone, eye color, and hair shade, then outputs your season with 30+ complementary colors." },
  ...
  "wardrobe-management-app-comparison": {
    ...
    sections: [
      { heading: "The Market Landscape", body: "The wardrobe app market has exploded. By 2026, there are over twenty options — but quality varies. Some are glorified photo albums. Others, like LUXOR®, are AI platforms that learn and evolve with your style." },
      ...
      { heading: "Where LUXOR® Leads", body: "LUXOR® leads in AI outfit generation (weather + calendar), Style DNA profiling, cost-per-wear analytics, wardrobe gap detection, and a social layer for sharing looks. The free tier works for casual users; Pro unlocks full AI capability." },
      ...
      { heading: "Privacy Is Non-Negotiable", body: "Privacy is non-negotiable. Your wardrobe is intimate data. Look for end-to-end encryption and clear data policies. LUXOR® uses encrypted cloud storage with zero third-party sharing." },
    ],
  },
};
...
const BlogArticle = () => {
  ...
  return (
    <>
      <Helmet>
        <title>{article.title} | LUXOR® Blog</title>
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "author": { "@type": "Organization", "name": "LUXOR®", "url": "https://luxor.ly" },
            "publisher": { "@type": "Organization", "name": "LUXOR®", "url": "https://luxor.ly" },
          ...
          <article className="flex-1 min-w-0 px-4 sm:px-6 py-12 md:py-20">
            ...
            >
              ...
              <p className="text-sm text-muted-foreground mb-6 max-w-md mx-auto">
                Thousands use LUXOR® to dress smarter every day.
              </p>
              <Link
                to="/auth"
