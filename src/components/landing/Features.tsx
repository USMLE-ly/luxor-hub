...
const timelineData = [
  {
    ...
    title: "Style DNA",
    date: "AI Core",
    content: "Upload a selfie and a few wardrobe shots. Within seconds, AURELIA knows your proportions, your color season, and the cuts that flatter you most.",
    category: "AI Styling",
    icon: Brain,
    relatedIds: [2, 3],
  ...
  },
  {
    ...
    date: "Commerce",
    content: "AURELIA identifies the holes in your wardrobe and finds pieces to fill them. Every recommendation has a reason behind it.",
    category: "Shopping",
    icon: ShoppingBag,
    relatedIds: [3, 6],
    status: "in-progress" as const,
