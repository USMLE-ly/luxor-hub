import { DEFAULT_DNA, ceramicMat, warmMapleMat, ivoryPolymerMat, darkAccentMat, createBodyProfile, POSES, isTopCat, isBottomCat, isSkirtCat, isDressCat, isOuterCat, isShoeCat, isHatCat, isBagCat } from "./mannequin-constants";
import type { GarmentSubtype, PosePreset } from "./mannequin-constants";
