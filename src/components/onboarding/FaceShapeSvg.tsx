/**
 * Premium face shape SVG illustrations with gradient shading, highlights, and refined features.
 */
    ...
    <div className={className}>
      ...
      >
        <defs>
          ...
          <linearGradient id={hlId} x1="20%" y1="0%" x2="80%" y2="100%">
            <stop offset="0%" stopColor="hsl(30, 80%, 93%)" stopOpacity="0.5" />
            <stop offset="100%" stopColor="transparent" stopOpacity="0" />
          </linearGradient>
          <filter id={shId} x="-10%" y="-10%" width="120%" height="120%">
            <feDropShadow dx="0" dy="1" stdDeviation="1.5" floodColor="hsl(15, 40%, 30%)" floodOpacity="0.12" />
          </filter>
        ...
        {/* Overlay fill with gradient + shadow */}
        <path
          d={shapeDef.overlay}
          fill={`url(#${gradId})`}
        ...
        {/* Guides */}
        <g opacity="0.15">
          <line x1="50" y1="4" x2="50" y2="96" stroke="hsl(var(--primary))" strokeWidth="0.3" strokeDasharray="2,2" />
          <line x1="10" y1="50" x2="90" y2="50" stroke="hsl(var(--primary))" strokeWidth="0.3" strokeDasharray="2,2" />
        </g>
      </svg>
    </div>
  );
