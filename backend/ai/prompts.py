...
Return ONLY valid JSON with these exact keys (no other text, no code fences):
{
  ...
  "generation_prompt": "SUBJECT: A HYPERREALISTIC FULL-BODY FASHION EDITORIAL PHOTOGRAPH OF A MODEL STANDING CONFIDENTLY WITH POISED, ELEGANT POSTURE. WEARING [exact colors and garments seen]. MATTE NATURAL SKIN WITH VISIBLE PORES, REALISTIC EPIDERMAL GRAIN, GENTLE COMPLEXION VARIATIONS, MICRO-TEXTURE, AND SUBTLE IMPERFECTIONS PRESERVED AUTHENTICALLY. RELAXED YET SOPHISTICATED STANCE. NO EXTRA LIMBS, NO DEFORMITIES, TWO VISIBLE LEGS AND TWO ARMS.\nMEDIUM: 8K ULTRA-PHOTOREALISTIC FASHION PHOTOGRAPH, DSLR FULL-FRAME CAMERA, 85MM FOCAL LENGTH, CRISP OPTICAL CLARITY, HIGH-FIDELITY FABRIC RENDERING WITH REALISTIC TEXTURE AND MICRO-DETAILS, PREMIUM EDITORIAL FINISH.\nENVIRONMENT: MINIMALIST HIGH-END FASHION STUDIO SETTING. SOFT SEAMLESS WHITE OR NEUTRAL GREY GRADIENT BACKDROP. CLEAN, UNCLUTTERED, DISTRACTION-FREE SPACE EMPHASIZING GARMENT DETAILS, TEXTURE, AND SILHOUETTE.\nLIGHTING: SOFT DIFFUSED STUDIO LIGHTING. NATURAL, BALANCED ILLUMINATION PROVIDING GENTLE HIGHLIGHTS AND MICRO-SHADOWS ACROSS FABRIC AND SKIN. TRUE-TO-LIFE LIGHT SCATTERING ACROSS SKIN AND TEXTILE SURFACES. VOLUMETRIC MICRO-SHADOWING ON FACIAL CONTOURS AND HAIR STRANDS. NO HARSH CONTRAST, NO ARTIFICIAL GLOW. SMOOTH, BALANCED SHADOW-TO-LIGHT TRANSITIONS.\nCOLOR: TRUE-TO-LIFE COLOR CALIBRATION. HARMONIOUS PALETTE FEATURING NATURAL SKIN UNDERTONES AND PRECISE TEXTILE COLORS. ACCURATE RENDERING OF ALL GARMENTS WITHOUT OVERSATURATION. GENTLE TONAL GRADIENTS AND AUTHENTIC COLOR VARIATION.\nMOOD: MODERN, REFINED, MINIMALIST LUXURY. CONFIDENT, ELEGANT, EFFORTLESSLY SOPHISTICATED. PREMIUM HIGH-FASHION EDITORIAL ATMOSPHERE WITH QUIET, UNDERSTATED CONFIDENCE.\nCOMPOSITION: FULL-BODY FRAMING, STRAIGHT-ON OR SLIGHTLY ANGLED VIEW, CENTERED COMPOSITION. SHOT WITH AN 85MM FASHION LENS ON A FULL-FRAME SENSOR. SHALLOW DEPTH OF FIELD KEEPING THE MODEL AND OUTFIT IN SHARP FOCUS WHILE THE BACKGROUND FALLS SOFTLY OUT OF FOCUS. MAGAZINE-READY EDITORIAL QUALITY WITH BALANCED, SYMMETRICAL FRAMING."
}
...
Return ONLY JSON:
{
  ...
  "generated_prompt": "Detailed Pollinations image prompt (only when complete). Must follow the 7-section editorial fashion structure: SUBJECT (detailed person description with clothing colors/types, natural skin texture, visible pores, realistic epidermal grain), MEDIUM (8K ultra-photorealism, DSLR full-frame clarity), ENVIRONMENT (minimalist studio background, clean gradient backdrop), LIGHTING (soft diffused studio lighting, balanced illumination), COLOR (true-to-life calibration, harmonious palette), MOOD (confident, modern luxury), COMPOSITION (85mm fashion lens, full-body framing, two visible legs, natural proportions, no deformities, no extra limbs, shallow depth of field, magazine-ready editorial quality). Example: \'SUBJECT: HYPERREALISTIC FULL-BODY FASHION EDITORIAL PHOTOGRAPH OF A WOMAN STANDING CONFIDENTLY, WEARING A NAVY BLUE BLAZER AND CREAM TROUSERS. NATURAL SKIN TEXTURE WITH VISIBLE PORES. MEDIUM: 8K ULTRA-PHOTOREALISTIC FASHION PHOTOGRAPH, DSLR FULL-FRAME CLARITY. ENVIRONMENT: MINIMALIST HIGH-END FASHION STUDIO WITH SOFT GRADIENT BACKDROP. LIGHTING: SOFT DIFFUSED STUDIO LIGHTING. COLOR: TRUE-TO-LIFE COLOR CALIBRATION. MOOD: CONFIDENT, MODERN LUXURY. COMPOSITION: 85MM FASHION LENS, FULL-BODY FRAMING, TWO VISIBLE LEGS, NATURAL PROPORTIONS. NO DEFORMITIES. MAGAZINE-READY EDITORIAL QUALITY.\'",
