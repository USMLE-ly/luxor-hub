...
Return ONLY valid JSON with these exact keys (no other text, no code fences):
{
  ...
  "generation_prompt": "SUBJECT: A fashion model standing confidently in a full-body shot, wearing [exact colors and garments seen]. Natural skin texture with visible pores, realistic epidermal grain, gentle complexion variations, subtle imperfections preserved authentically. Poised, elegant posture with relaxed confidence.\nMEDIUM: 8K ULTRA-PHOTOREALISTIC FASHION PHOTOGRAPH, DSLR FULL-FRAME CAMERA, CRISP OPTICAL CLARITY, HIGH-FIDELITY FABRIC RENDERING, PREMIUM EDITORIAL FINISH.\nENVIRONMENT: MINIMALIST HIGH-END FASHION STUDIO SETTING. SOFT SEAMLESS WHITE OR NEUTRAL GREY GRADIENT BACKDROP. CLEAN, UNCLUTTERED, DISTRACTION-FREE SPACE EMPHASIZING GARMENT DETAILS AND SILHOUETTE.\nLIGHTING: SOFT DIFFUSED STUDIO LIGHTING. NATURAL, BALANCED ILLUMINATION PROVIDING GENTLE HIGHLIGHTS AND MICRO-SHADOWS. NO HARSH CONTRAST, NO ARTIFICIAL GLOW. TRUE-TO-LIFE LIGHT SCATTERING ACROSS SKIN AND FABRIC.\nCOLOR: TRUE-TO-LIFE COLOR CALIBRATION. HARMONIOUS PALETTE FEATURING NATURAL SKIN TONES AND PRECISE TEXTILE COLORS. ACCURATE RENDERING OF ALL GARMENTS WITHOUT OVERSATURATION.\nMOOD: MODERN, REFINED, MINIMALIST LUXURY. CONFIDENT, ELEGANT, EFFORTLESSLY SOPHISTICATED. PREMIUM HIGH-FASHION EDITORIAL ATMOSPHERE.\nCOMPOSITION: FULL-BODY FRAMING, STRAIGHT-ON ANGLE, CENTERED COMPOSITION. SHOT WITH AN 85MM FASHION LENS, FULL-FRAME SENSOR QUALITY. SHALLOW DEPTH OF FIELD KEEPING THE MODEL AND OUTFIT IN SHARP FOCUS WHILE THE BACKGROUND FALLS SOFTLY OUT OF FOCUS. TWO VISIBLE LEGS, NATURAL HUMAN PROPORTIONS, NO DEFORMITIES, NO EXTRA LIMBS. MAGAZINE-READY EDITORIAL QUALITY."
}
