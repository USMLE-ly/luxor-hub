import{c as s,N as l,u as r,j as e,m as i,y as h}from"./index-y5Y_BBwD.js";import{S as d}from"./shirt-CJI81aV6.js";/**
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const y=s("Sparkles",[["path",{d:"M9.937 15.5A2 2 0 0 0 8.5 14.063l-6.135-1.582a.5.5 0 0 1 0-.962L8.5 9.936A2 2 0 0 0 9.937 8.5l1.582-6.135a.5.5 0 0 1 .963 0L14.063 8.5A2 2 0 0 0 15.5 9.937l6.135 1.581a.5.5 0 0 1 0 .964L15.5 14.063a2 2 0 0 0-1.437 1.437l-1.582 6.135a.5.5 0 0 1-.963 0z",key:"4pj2yx"}],["path",{d:"M20 3v4",key:"1olli1"}],["path",{d:"M22 5h-4",key:"1gvqau"}],["path",{d:"M4 17v2",key:"vumght"}],["path",{d:"M5 18H3",key:"zchphs"}]]),u=[{label:"DNA",icon:c,path:"/dashboard"},{label:"Schedule",icon:p,path:"/outfit-calendar"},{label:"Analysis",icon:m,path:"/outfit-analysis"},{label:"Dressing Room",icon:y,path:"/dressing-room"},{label:"Closet",icon:d,path:"/closet"}];function b(){const o=l(),n=r();return e.jsx("nav",{"aria-label":"Primary",className:"fixed bottom-0 inset-x-0 z-50 bg-background/80 backdrop-blur-lg border-t border-border/50 pb-[env(safe-area-inset-bottom)]",children:e.jsx("ul",{className:"flex items-center justify-around h-14 max-w-lg mx-auto list-none m-0 p-0",children:u.map(a=>{const t=o.pathname===a.path||a.path==="/dashboard"&&o.pathname==="/style-dna"||a.path==="/dashboard"&&o.pathname==="/color-type";return e.jsx("li",{className:"flex",children:e.jsxs("button",{type:"button",onClick:()=>{h("selection"),n(a.path)},"aria-label":a.label,"aria-current":t?"page":void 0,className:"flex flex-col items-center justify-center gap-0.5 min-w-11 min-h-11 px-2 relative rounded-md focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring",children:[e.jsx(i.div,{animate:{scale:t?1.12:1},transition:{type:"spring",stiffness:400,damping:20},children:e.jsx(a.icon,{className:`w-[18px] h-[18px] transition-colors ${t?"text-primary":"text-muted-foreground"}`,strokeWidth:t?2.4:1.8,"aria-hidden":"true"})}),e.jsx("span",{className:`text-[9px] font-sans transition-colors ${t?"text-primary font-semibold":"text-muted-foreground"}`,children:a.label}),t&&e.jsx(i.div,{layoutId:"bottomNavDot",className:"absolute -bottom-0.5 w-1 h-1 rounded-full bg-primary",transition:{type:"spring",stiffness:500,damping:30}})]})},a.label)})})})}export{b as B,p as C,y as S,m as a};
