...
const LoadingScreen = () => {
  return (
    <div className="fixed inset-0 z-[90] flex flex-col items-center justify-center bg-[#10352a] overflow-hidden">
      {/* Luxor Golden Diamond Loader */}
      ...
      {/* Animation keyframes (self-contained) */}
      <style>{`
