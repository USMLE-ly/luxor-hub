import { k as commonjsGlobal, g as getDefaultExportFromCjs, j as jsxRuntimeExports, r as reactExports } from "./index-BJjnbSuc.js";
import { t as toast } from "./index-DqqhH6-L.js";
import { d as createLucideIcon, c as cn } from "./AppContent-4cFLEqQ4.js";
...
const VoiceInput = ({ onTranscript, disabled }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "button",
    {
      ...
      disabled,
      className: `w-8 h-8 rounded-full flex items-center justify-center flex-shrink-0 transition-all ${isListening ? "bg-destructive text-destructive-foreground animate-pulse shadow-[0_0_12px_hsl(var(--destructive)/0.4)]" : "text-muted-foreground hover:text-primary"}`,
...
function PlaceholdersAndVanishInput({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    ...
    {
      className: cn(
        "w-full relative max-w-xl mx-auto bg-card/60 backdrop-blur-xl h-12 rounded-full overflow-hidden border border-border shadow-[0_2px_12px_-4px_hsl(var(--gold)/0.15)] transition duration-200",
        value && "bg-card/80"
      ),
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            disabled: !value,
            type: "submit",
            className: "absolute right-2 top-1/2 z-50 -translate-y-1/2 h-8 w-8 rounded-full disabled:bg-secondary bg-primary text-primary-foreground transition duration-200 flex items-center justify-center",
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
              motion.svg,
              {
                ...
                className: "text-primary-foreground/60 h-4 w-4",
                children: [
...
function MoodSelector({ selected, onSelect }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-1.5 py-2 px-1 overflow-x-auto scrollbar-none", children: moods.map((mood) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.button,
    {
      whileTap: { scale: 0.9 },
      onClick: () => onSelect(selected === mood.value ? "" : mood.value),
      className: `flex items-center gap-1.5 px-3 py-1.5 rounded-full border transition-all flex-shrink-0 ${selected === mood.value ? "bg-primary/15 border-primary/40 shadow-[0_0_8px_hsl(var(--primary)/0.15)]" : "bg-card border-border hover:border-primary/20"}`,
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-base", children: mood.emoji }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[11px] font-sans text-foreground", children: mood.label })
      ]
    },
    mood.value
  )) });
...
export {
  MoodSelector as M,
  PlaceholdersAndVanishInput as P,
  VoiceInput as V,
  Markdown as a,
  useAutoResizeTextarea as u
};
